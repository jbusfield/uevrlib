...
When you have the correct reticule selected in the dropdown press Add Selected Reticule. If you now close the UEVR UI window the reticule should be connected to your right controller if you have the UEVR Aim Method set to Right Controller.
...
Additional settings such as position, scale, remove from viewport, two sided and collision channel can be configured.
